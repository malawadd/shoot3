...
contract Shoot3membership is ERC721URIStorage, Ownable {
    ...
    string private _tablePrefix = "Shoot3";
    // someday we update this with a nuxt app that diplays x,y and
    // gives you the interface to move x,y.
    string private _externalURL = "Shoot3.me";
    string private _image =
        "https://bafybeigegphczsyba3tkv5dg7jbowidlpatlc2ylkwr7ejlrg3qka7nsw4.ipfs.nftstorage.link/";

    constructor(address registry) ERC721("Shoot3membership", "Shoot3") {
        _tableland = ITablelandTables(registry);
        _metadataTableId = _tableland.create(
            address(this),
            string.concat(
                "CREATE TABLE ",
                _tablePrefix,
    ...
    function updateNft(uint256 tokenId, string calldata image, string calldata description) public {
